...
class PLSClient(StackingProtocol):
    ...
    def validate(self, certificate):
        ...
        rootcert = CipherUtil.loadCertFromFile("/root/Downloads/root.crt")
        rootsubject = CipherUtil.getCertSubject(rootcert)


        if clientissuer == intermediatesubject:
    ...
    def data_received(self, data):
        ...
        for packet in self.deserializer.nextPackets():
            ...
            if isinstance(packet, PlsKeyExchange):
                ...
                self.m.update(packet.__serialize__())
                serverpriv = CipherUtil.loadPrivateKeyFromPemFile("/root/Downloads/prashanth-client.key")
