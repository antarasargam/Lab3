...
from netsec_2017.Lab_3.PLS import server, serverfactory
from netsec_2017.Lab_3.packets import PEEPpacket
...
class PEEPServerProtocol(StackingProtocol):
        ...
        for pkt in self.deserializer.nextPackets():
            ...
            # Reset packet received
                ...
                if checkvalue:
                    ...
                    print("ACK Received from the client with Ack. No. :", pkt.Acknowledgement)
    ...
    def sending_ripack(self, RIP_PKT):
        ...
        print("Sent RIP-ACK with Ack. No. :", ripack.Acknowledgement)
    ...
    def encapsulating_packet(self, data_from_BL_1):
        ...
        print("Data packet sent with Seq. No.", self.Sencap.SequenceNumber, "and Ack. No.",self.Sencap.Acknowledgement, "with size of", len(chunk), "bytes")
